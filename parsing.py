...
#print(get_description('https://kaktus.media/doc/474599_piat_sfer_ekonomiki_kotorye_sobirautsia_razvivat_kyrgyzstan_i_yzbekistan.html'))
...
def write_to_json(news):
    with open('news_{today}.json', 'w') as file:
